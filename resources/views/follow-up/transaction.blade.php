...
<div class="main-content follow-up-page">
    ...
    <div class="tab-message">
        <button class="tablinks-message" onclick="openPm(event, 'Awaiting payment')" id="defaultOpenPm">Awaiting
            payment</button>
        <button class="tablinks-message" onclick="openPm(event, 'Confirmation')">Confirmation</button>
    </div>
    <hr class="line-tab" style="margin-bottom: 20px">

    <div id="Awaiting payment" class="tabcontent-message">
            ...
            <div class="top-box">
                <div class="left">
                    ...
                    <p>Raih kesempatan mendapatkan produk berkualitas dengan harga terjangkau. Dapatkan informasi
                        ...
                        menyenangkan.</p>
                    <button class="editBro" data-bs-toggle="modal" data-bs-target="#editAwaitingpayment">Edit
                        text</button>
                </div>
                <div class="right">
    ...
    <div id="Confirmation" class="tabcontent-message">
        <div class="info-follup">
            <i class="fa-solid fa-info circle-icon"></i>
            <p>Kamu bisa melakukan penawaran produk kepada calon pelanggan yang berpotensi menjadi pelanggan kamu,
                terdapat 10 penjadwalan yang bisa dipilih.</p>
            ...
            <div class="top-box">
                <div class="left">
                    ...
                    <p>Raih kesempatan mendapatkan produk berkualitas dengan harga terjangkau. Dapatkan informasi
                        langsung tentang promo terbaru kami di WhatsApp dan nikmati pengalaman belanja yang mudah dan
                        menyenangkan.</p>
                    <button class="editBro" data-bs-toggle="modal" data-bs-target="#editConfirmation">Edit text</button>
                </div>
                <div class="right">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
...
<div class="modal fade" id="editAwaitingpayment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="form-group _form-group">
                    <textarea id="titleBroadcast" name="title" type="text" class="form-control"
                        placeholder="Input title broadcast" value="Awaiting payment"
                ...
                <div class="form-group _form-group">
                    <select id="tr_ap" name="tr_ap" class="custom-select" tabindex="2">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="width: 440px">
            ...
            <div class="modal-body">
                ...
                <div class="form-group _form-group">
                    <select id="tr_confirmation" name="tr_confirmation" class="custom-select" tabindex="2">
                        <option>Ready to send</option>
                    </select>
                </div>
